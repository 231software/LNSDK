    ...
    static register<T extends FMPCommand>(command:T):boolean{
        ...
        const esCmdPermission={
            ...
            default: (()=>{switch(command.permission){
                case FMPInternalPermission.Any:return Enums.PermissionDefault.True;
                case FMPInternalPermission.Admin:
                case FMPInternalPermission.GameMasters:
                case FMPInternalPermission.HostPlayer:
                case FMPInternalPermission.Console:
                case FMPInternalPermission.Internal:return Enums.PermissionDefault.False
            }})()
        }
