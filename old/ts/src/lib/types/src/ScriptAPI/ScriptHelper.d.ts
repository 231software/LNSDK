...
declare enum liteloaderPluginVersion{
    Release,
    Beta,
    Dev
}
...
declare namespace ll{
     ...
     */
    function registerPlugin(name:string, introduction:string, version:[number,number,number,liteloaderPluginVersion?], otherInformation:Record<string,string>):void;
}
